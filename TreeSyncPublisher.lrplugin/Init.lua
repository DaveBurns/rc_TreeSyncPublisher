        ...
        if status then
            if contents then
                ...
                if func then
                    ...
                    elseif err:len() > 77 then -- test on Mac ###
                        err = err:sub( -77 )
                    end
...
_G.TreeSyncObjectFactory = require( 'TreeSyncObjectFactory' )    -- class of object used to create objects of classes not mandated by the framework.
_G.objectFactory = TreeSyncObjectFactory:new()               -- object used to create objects of classes not mandated by the framework.
...
_G.encoder = require( 'encoder' )
_G.FtpAgApp = require( 'ExternalApps/FtpAgApp' )
_G.SmartCollections = require( 'Catalog/SmartCollections' )
_G.TreeSyncManager = require( 'TreeSyncManager' )
...
_G.Publish = require( 'ExportAndPublish/Publish' )
_G.FtpExport = require( "ExportAndPublish/FtpExport" )
_G.FtpPublish = require( "ExportAndPublish/FtpPublish" )
_G.PublishServices = require( 'Catalog/PublishServices' )
_G.XmlRpc = require( 'Communication/XmlRpc' )
-- _G.RpcBackground = require( 'System/RpcBackground' ) -- plugin generator?
_G.Lightroom = require( 'Lightroom/Lightroom' )
_G.lightroom = Lightroom:new()
_G.Common = require( 'Common' )
_G.TreeSyncPublish = require( 'TreeSyncPublish' )
...
TreeSyncManager.initPrefs()
exifTool = ExifTool:new()
simpleXml = XmlSimple:new()
ftpAgApp = FtpAgApp:new()
auxSettings = {}
app:initDone()
